        ...
        <section>
            ...
            {open && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4" onClick={resetSearchModal}>
                    <div className="relative flex h-[47vh] w-full max-w-md flex-col rounded-2xl bg-white p-5 shadow-xl" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="mb-4 flex gap-2 pr-16">
                            ...
                            />
                            <button className="rounded bg-black px-4 py-2 text-white disabled:bg-gray-400" onClick={() => searchProfiles()} disabled={loading}>
                                검색
                            </button>
                        </div>
